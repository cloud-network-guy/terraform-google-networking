...
| <a name="input_enable_netapp_cv"></a> [enable\_netapp\_cv](#input\_enable\_netapp\_cv) | Enable PSA Connection Legacy NetApp Cloud Volumes (depreciated as of 2025) | `bool` | `false` | no |
