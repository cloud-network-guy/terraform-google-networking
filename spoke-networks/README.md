...
|------|-------------|------|---------|:--------:|
| <a name="input_advertise_netapp_ip_range"></a> [advertise\_netapp\_ip\_range](#input\_advertise\_netapp\_ip\_range) | Advertise NetApp PSA range via Internal VPNs | `bool` | `false` | no |
| <a name="input_advertise_servicenetworking_ip_range"></a> [advertise\_servicenetworking\_ip\_range](#input\_advertise\_servicenetworking\_ip\_range) | Advertise Service Networking PSA range via Internal VPNs | `bool` | `false` | no |
...
| <a name="input_enable_netapp"></a> [enable\_netapp](#input\_enable\_netapp) | Enable PSA Connection Google Cloud NetApp Volumes | `bool` | `false` | no |
| <a name="input_enable_netapp_gcnv"></a> [enable\_netapp\_gcnv](#input\_enable\_netapp\_gcnv) | Enable PSA Connection Google Cloud NetApp Volumes (old variable name) | `bool` | `false` | no |
