...
| [google_storage_bucket_iam_member.storage_viewers](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/storage_bucket_iam_member) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_bucket"></a> [bucket](#input\_bucket) | Name of GCS Bucket to grant Storage Viewer Permissions on | `string` | `null` | no |
...
| <a name="input_storage_viewers"></a> [storage\_viewers](#input\_storage\_viewers) | Service Accounts with Storage Viewer Permissions | `list(string)` | `[]` | no |
