...
| <a name="requirement_google"></a> [google](#requirement\_google) | >= 4.49.0, < 8.0.0 |
...
| <a name="input_disk"></a> [disk](#input\_disk) | n/a | <pre>object({<br/>    image   = optional(string)<br/>    type    = optional(string)<br/>    size    = optional(number)<br/>    size_gb = optional(number)<br/>    labels  = optional(map(string))<br/>  })</pre> | `{}` | no |
